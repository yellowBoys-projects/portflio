        ...
        >
          ...
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white tracking-tight mb-8 leading-tight">
              Creative <span className="text-gradient bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Digital</span> Designer
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl font-light">
              Hi, I'm <span className="font-semibold text-gray-900 dark:text-white">Duncan</span> — a passionate digital designer and Framer developer crafting impactful digital experiences that drive results.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mb-14">
            {[
              { value: "12+", label: "Years Experience", color: "group-hover:text-blue-600" },
              { value: "270+", label: "Projects Done", color: "group-hover:text-purple-600" },
              { value: "50+", label: "Happy Clients", color: "group-hover:text-green-600" }
            ].map((stat, idx) => (
              <div key={idx} className="text-center lg:text-left group">
                <div className={`text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-3 transition-colors duration-300 ${stat.color}`}>
                  {stat.value}
                </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
            <div className="flex items-center gap-4">
              {/* Social Buttons */}
              {[
                { color: "blue-50", border: "blue-500", icon: (
  <>
